...
\usepackage{hyperref}
\hypersetup{
            pdftitle={Amplify Samotsvety: Probably Better Methods for Rewarding Forecasters},
...
with forecasting. With regards to first-principle reasoning, both steps
of the system are incentive compatible, and rational actors would thus
be incentivized to predict reality.
